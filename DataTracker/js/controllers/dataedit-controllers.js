...
mod_edit.controller('DataEditCtrl', ['$scope','$q','$sce','$routeParams','DataService','$modal','$location','$rootScope','ActivityParser','DataSheet',
	...
	function($scope, $q, $sce, $routeParams, DataService, $modal, $location, $rootScope, ActivityParser, DataSheet, UploadService, DatastoreService, $upload){
		...
		$scope.addSection = function()
		{
			...
			var modalInstance = $modal.open({
              templateUrl: 'partials/invalidOperation/modal-invalid-operation.html',
