//CrppDocuments controller
'use strict';

var mod_crpp = angular.module('CrppContractsControllers', ['ui.bootstrap']);

var crppContractsController = ['$scope','$route','$routeParams', 'DataService', '$modal', '$location','$window', '$rootScope','DatastoreService',
    	function ($scope, $route, $routeParams, DataService, $modal, $location, $window, $rootScope, DatastoreService) {
            ...
            $scope.columnDefs = [
                        ...
                        {field:'headerdata.Allotment',displayName: 'Document Id', cellTemplate: allotmentTemplate, width: '140px'},
                        {field:'headerdata.AllotmentStatus',displayName: 'Status'},
                        {field:'headerdata.CobellAppraisalWave',displayName: 'Activity Type', width: '200px'},
...
//                console.dir($scope.gridOptions.selectedItems[0].Location.SdeObjectId);
            ...
            {
				console.log("Inside crppContractsController, newRecord...");
                //create a new location from the map feature selected
                /*var new_location = {
                    LocationTypeId: LOCATION_TYPE_CRPP,
            ...
            $scope.reloadProjectLocations = function(){
				console.log("Inside CrppDocuments-controller.js, $scope.reloadProjectLocations...");
...
mod_crpp.controller('CrppContractsCtrl', crppContractsController);