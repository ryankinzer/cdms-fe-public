var dataset_import = ['$scope', '$routeParams', 'ProjectService', 'CommonService', 'SubprojectService', 'DatasetService',
    ...
    function ($scope, $routeParams, ProjectService, CommonService, SubprojectService, DatasetService, $location, $upload, ActivityParser, DataSheet,
        ...
        */
        ...
        $scope.setInstrumentInitial = function () {
            //console.log("Inside $scope.setInstrumentInitial...");

            // When the page first loads, although the instrument is set, the accuracy checks are not.
            // We need to check if the selected instrument has any accuracy checks.
            $scope.viewInstrument = getByField($scope.project.Instruments, $scope.ActivityFields.InstrumentId, "Id");
            //console.log("$scope.viewInstrument is next...");
            //console.dir($scope.viewInstrument);
		...
		$scope.displayImportPreview = function()
		{
            ...
            // When the results first load, we must set AccuracyCheck, for the chosen instrument
            $scope.setInstrumentInitial();	
