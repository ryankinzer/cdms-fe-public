...
*
* this is a self-contained login application (not a module or a controller only)
* in this file are the module + routes + services + controllers necessary to login to cdms.
* upon success, the api service will have set a cookie and redirected to the main cdms application.
*/
...
{
	$routeProvider.when('/login', {templateUrl: 'app/core/login/templates/login.html', controller: 'LoginCtrl'});
    $routeProvider.when('/logout', { templateUrl: 'app/core/login/templates/login.html', controller: 'LogoutCtrl'});
