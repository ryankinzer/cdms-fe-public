//this is a copy of the leasingMap directive... probably can consolidate at some point?
        ...
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                function setupHoverQuery () { 
                    ...
                    var queryTask = new QueryTask("https://arcserv.ctuir.org/arcgis/rest/services/FarmTracts_RAF/MapServer/0");
                    //build query filter
                    var query = new Query();
...
ArcGISTiledMapServiceLayer, ArcGISDynamicMapServiceLayer,
            GraphicsLayer, SimpleFillSymbol, SimpleLineSymbol, Query, QueryTask, Graphic) {
      ...
      controller: function($scope, $element, $attrs){
        ...
        map.updateLayers = function(){
            ...
            try{
              ...
              //now add any selected service layers
              for (var i = map.selectedServiceLayers.length - 1; i >= 0; i--) {
                var service_layer = new ArcGISDynamicMapServiceLayer(servicesLayerConfig[map.selectedServiceLayers[i]].ServiceURL);
                map.addLayer(service_layer);
              };
