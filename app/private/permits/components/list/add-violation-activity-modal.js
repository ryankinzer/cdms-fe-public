...
var modal_edit_violationevent = ['$rootScope','$scope', '$uibModal','$uibModalInstance','GridService','Upload','ViolationService',
    ...
    function ($rootScope, $scope, $modal, $modalInstance, GridService, $upload, ViolationService) {
        ...
        $scope.row = $scope.activity_modal; //event form -- note: this creates a LOCAL scope variable for the EVENT that will go away when this scope goes away...
...
*/
            ...
            if (!$scope.row.Id) {
                ...
                var new_event = ViolationService.saveViolationEvent(to_save);
        ...
        $scope.modalFile_saveParentItem = function (saveRow) {
            ...
            $scope.saved_event = ViolationService.saveViolationEvent(saveRow);
        ...
        if ($scope.mode === 'edit') {
            $scope.violationEventsGrid.columnDefs.forEach(function (field) {
