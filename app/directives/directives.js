...
mod.directive('ctuirTextField',
    function(){
        var result = {
            templateUrl: 'app/partials/dataentry/field-text.html',
            restrict: 'E',
        };
...
mod.directive('ctuirTextareaField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-textarea.html',
            restrict: 'E',
        };
...
mod.directive('ctuirDateField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-date.html',
            restrict: 'E',
        };
...
mod.directive('ctuirTimeField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-time.html',
            restrict: 'E',
        };
...
mod.directive('ctuirEastingField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-easting.html',
            restrict: 'E',
        };
...
mod.directive('ctuirNorthingField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-northing.html',
            restrict: 'E',
        };
...
mod.directive('ctuirNumberField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-number.html',
            restrict: 'E',
        };
...
mod.directive('ctuirSelectField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-select.html',
            restrict: 'E',
...
mod.directive('ctuirMultiselectField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-multiselect.html',
            restrict: 'E',
            controller: function($scope, $element, $attrs) {
               $scope.selectOptions = makeObjectsFromValues($scope.dataset.DatastoreId+$scope.field.DbColumnName, $scope.field.Field.PossibleValues);
            }
...
mod.directive('ctuirMultilookupField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-multilookup.html',
            restrict: 'E',
            controller: function($scope, $element, $attrs) {
               $scope.selectOptions = makeObjectsFromValues($scope.dataset.DatastoreId+$scope.field.DbColumnName, $scope.field.Field.PossibleValues);
            }
...
mod.directive('ctuirLookupField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-lookup.html',
            restrict: 'E',
            controller: function($scope, $element, $attrs) {
                $scope.selectOptions = makeObjectsFromValues($scope.dataset.DatastoreId+$scope.field.DbColumnName, $scope.field.Field.PossibleValues);
            }
...
mod.directive('ctuirFileField',
    function($modal){
        var result = {
            templateUrl: 'app/partials/dataentry/field-file.html',
            restrict: 'E',
        };
...
mod.directive('ctuirTempWaypointFileField',
    function($modal){
        var result = {
            templateUrl: 'app/partials/dataentry/field-waypoint-file.html',
            restrict: 'E',
        };
...
mod.directive('ctuirLinkField',
    function($modal){
        var result = {
            templateUrl: 'app/partials/dataentry/field-link.html',
            restrict: 'E',
            controller: function($scope, $element, $attrs)
            {
...
mod.directive('ctuirRadioField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-radio.html',
            restrict: 'E',
        };
...
mod.directive('ctuirCheckboxField',
    function(){
        ...
        var result = {
            templateUrl: 'app/partials/dataentry/field-checkbox.html',
            restrict: 'E',
        };
